			...
			<div className="form-holder">
				...
				>
					<h2 className="modal-heading">
						{section === 1 ? "Create a server" : "Customize your server"}
					</h2>
					<div className="sub-heading">
						{section === 1
							? "Your server is where you and your friend hang out. Make yours and start talking"
						...
						<>
							<div className="image-selector">
								<div className="icon-container">
									...
									<input
										type="file"
										className="server-avatar-selector"
										name="avatar"
										accept=".jpg,.jpeg,.png"
							...
							<div className="server-name-container">
								<label htmlFor="server-name" className="secondary-label">
									SERVER NAME
								</label>
								<input type="text" name="server-name" className="grayed-out" />
							</div>
							<div className="modal-footer">
								<button className="back" onClick={() => setSection(1)}>
									Back
								</button>
